...
-- UPDATE 그리고 DELETE는 WHERE절을 반드시 작성해야함
...
-- 4) 서울에 있는 중식집 중 평점 내림차순으로 6~10위 조회하기
SELECT *
FROM restaurants
WHERE
	category = '중식'
